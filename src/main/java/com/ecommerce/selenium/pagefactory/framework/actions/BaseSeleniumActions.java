...
import com.ecommerce.selenium.pagefactory.framework.browser.BrowserUtil;
...
import com.ecommerce.selenium.pagefactory.framework.exception.SeleniumActionsException;
import com.ecommerce.selenium.pagefactory.framework.pages.BaseTopLevelPage;
import com.ecommerce.selenium.pagefactory.framework.pages.SubPage;
...
public abstract class BaseSeleniumActions<B extends Browser> implements SeleniumActions {
    ...
    /**
     * Return the {@link com.ecommerce.selenium.pagefactory.framework.browser.Browser} object this actions class is tied to.
     */
    @Override
    public B getBrowser() {
        return browser;
