package com.ecommerce.selenium.pagefactory.framework.browser.web;

import com.ecommerce.selenium.pagefactory.framework.browser.Browser;
...
import com.ecommerce.selenium.pagefactory.framework.pages.BaseTopLevelPage;
import com.ecommerce.selenium.pagefactory.framework.pages.TopLevelPage;
import com.ecommerce.selenium.pagefactory.framework.webservice.EndpointBuilder;
...
public abstract class WebBrowser extends Browser<WebDriver> {
     ...
     * @return - a generic {@link com.ecommerce.selenium.pagefactory.framework.pages.BaseTopLevelPage}
     * page object. To open a page with more specific functionality, you must extend
     * {@link com.ecommerce.selenium.pagefactory.framework.pages.BaseTopLevelPage} and then
     ...
     * @param pageClass - the {@link com.ecommerce.selenium.pagefactory.framework.pages.TopLevelPage} class to load.
     */
